...
# Indexes
#
#  index_terms_on_fingerprint_id         (fingerprint_id)
#  index_terms_on_suggested_resource_id  (suggested_resource_id)
#  unique_phrase                         (phrase) UNIQUE
#
# Foreign Keys
#
#  fingerprint_id         (fingerprint_id => fingerprints.id)
#  suggested_resource_id  (suggested_resource_id => suggested_resources.id) ON DELETE => nullify
#
